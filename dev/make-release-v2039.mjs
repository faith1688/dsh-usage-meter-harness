// dev/make-release-v2039.mjs — 创建 v2.0.39 GitHub Release 并上传 npm pack 产物。
// token 从环境变量 GH_TOKEN 读取（由 git credential fill 注入），绝不打印。
// 发布说明正文来自 dev/release-notes-v2039.md（单一事实来源，便于 review/diff）。
// 用法：$env:GH_TOKEN=<token>; node dev/make-release-v2039.mjs
...
const tag = 'v2.0.39';
const assetPath = 'faith1688-dsh-usage-meter-harness-2.0.39.tgz';
const api = 'https://api.github.com';
const notes = readFileSync('dev/release-notes-v2039.md', 'utf8');
