    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          rate !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { whiteSpace: "nowrap", fontWeight: 700, ...rate >= 100 ? { background: "linear-gradient(90deg, #4d6bfe, #8b5cf6, #f59e0b)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" } : rate >= 50 ? { background: "linear-gradient(90deg, #4d6bfe 0%, #38bdf8 55%, #bae6fd 100%)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" } : { color: "#f59e0b" } }, children: [
            "\xB7 ",
            tt("speed"),
            " ",
            rate.toFixed(1),
