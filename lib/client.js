        ...
        setEdits((prev) => {
          ...
          for (const k of Object.keys(next)) {
            ...
            if (b !== void 0 && typeof b.balance === "number") {
              ...
              if (cur !== void 0) next[k] = { ...cur, balance: String(Math.round(converted * 1e6) / 1e6) };
            }
          }
          return next;
        });
                  ...
                  e.templateId === "" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                    ...
                    e.customRows.map((r, ri) => {
                      ...
                      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 6, flexWrap: "wrap" }, children: [
                        ...
                        e.peakOn ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11, color: t.text3, minWidth: 80, textAlign: "right" }, children: "\u5CF0\u8C37\u63A5\u7BA1 \u2192" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "input",
                          {
                            value: r.perM,
                            placeholder: "\u5143/M",
