      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...row, paddingTop: 6 }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontWeight: 700, color: p ? t.brand : t.text3 }, children: p ? fmtMoney(usage.estimatedCost, usage.currency, usage) : tt("noPriceData") })
          ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "16px 24px 24px", fontSize: 13, color: t.text }, children: [
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 13 }, children: L("\u52A0\u8F7D\u5168\u5C40\u914D\u7F6E\u2026") }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 11, color: t.ok, lineHeight: 1.5 }, children: tt("apiKeyTip") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, display: "flex", gap: 8, maxWidth: 360, alignItems: "center" }, children: [
          ...
          })(), style: { fontSize: 11, padding: "2px 10px", borderRadius: 6, border: `1px solid ${t.border}`, background: t.card, color: t.text, cursor: "pointer", whiteSpace: "nowrap" }, children: L("\u5237\u65B0\u6C47\u7387") })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 16, display: "flex", alignItems: "center", gap: 12 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", onClick: save, disabled: saving, style: { fontSize: 13, padding: "6px 18px", borderRadius: 6, border: `1px solid ${t.border}`, background: saving ? "rgba(139, 148, 158, 0.10)" : t.accent, color: saving ? t.text3 : t.text, cursor: saving ? "default" : "pointer" }, children: saving ? tt("savingUnit") : tt("save") }),
        "            ",
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: active.models.map((m) => {
              ...
              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { border: `1px solid ${t.border}`, borderRadius: 6, overflow: "hidden" }, children: [
                ...
                isOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("fieldset", { disabled: locked, style: { border: "none", margin: 0, padding: 0, minWidth: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "4px 12px 10px", display: "flex", flexDirection: "column", gap: 8, opacity: locked ? 0.75 : void 0 }, children: [
                    locked && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.error, fontSize: 11, lineHeight: 1.4 }, children: tt("lockedHint") }),
                    e.prefillOfficial && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.ok, fontSize: 11, lineHeight: 1.4 }, children: tt("prefillOfficial") }),
                    ...
                    e.usesSharedBalance === true && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.ok, fontSize: 11, lineHeight: 1.4 }, children: tt("sharedBalNote") }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "max-content 1fr", columnGap: 10, rowGap: 6, alignItems: "center" }, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11, color: t.text2, textAlign: "right" }, children: tt("currency") }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                        "select",
                        {
                          id: `um-cur-${k}`,
                      ...
                      !deep && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11, color: t.text2, textAlign: "right" }, children: tt("balance") }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "input",
                            {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.ok }, children: tt("balanceTip") })
                        ] })
                      ] }),
                      templates.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11, color: t.text2, textAlign: "right" }, children: tt("billingTemplate") }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                            "select",
                            {
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.ok }, children: tt("templateTip") })
                        ] })
                      ] }),
                      ...
                      e.discount !== "" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 11, color: t.text2, textAlign: "right" }, children: tt("batchDiscount") }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "input",
                          {
                            id: `um-disc-${k}`,
                            ...
                            placeholder: "\u5982 0.5",
                            style: { ...input, maxWidth: 90, fontSize: 12, padding: "2px 6px", justifySelf: "start" }
                          }
                        )
                      ] })
                    ] }),
                    e.templateId === "" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, fontWeight: 700, color: t.text2, marginBottom: 4 }, children: L("\u81EA\u5B9A\u4E49\u5355\u4EF7\u9879\uFF08\u6BCF\u884C = \u5355\u4EF7 \xD7 \u8BE5\u884C token \u6570\uFF1B\u5CF0\u8C37\u4EF7\u5728\u4E0B\u65B9\u300C\u542F\u7528\u5CF0\u8C37\u8BA1\u8D39\u300D\u91CC\u7EDF\u4E00\u586B\uFF09") }),
                    ...
                    e.templateId !== "" && !(deep || e.templateId === "peak-off-peak" || e.peakOn) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontSize: 12, fontWeight: 700, color: t.text2, marginBottom: 4 }, children: tt("basePrice") }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: 8 }, children: columnsForTemplate(e.templateId, templates).map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { flex: 1, display: "flex", flexDirection: "column", gap: 2, minWidth: 0 }, children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.text3 }, children: FIELD_LABEL[f] }),
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                          "input",
                          {
                            id: `um-${f}-${k}`,
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }, children: (deep || e.templateId === "peak-off-peak" || e.templateId === "" || e.peakOn) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 10, color: t.text3 }, children: [
                          "\u5CF0: \u9AD8; \u8C37: \u4F4E; ",
                          tt("uncheckIsOff")
                        ] })
                      ] }) }),
                      e.peakOn && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6, padding: "6px 8px", background: "rgba(139,148,158,0.06)", borderRadius: 4 }, children: [
                        e.templateId === "" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 4 }, children: e.customRows.map((r, ri) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.text3 }, children: tt("peakPrice") }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "input",
                            {
                              value: r.peakPerM,
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.text3 }, children: tt("offPrice") }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                            "input",
                            {
                              value: r.offPerM,
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.text3 }, children: lab }),
                          [[pk, "\u5CF0\u4EF7"], [off, "\u8C37\u4EF7"]].map(([fld, tag]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.text3, whiteSpace: "nowrap" }, children: tt(tag === "\u5CF0\u4EF7" ? "peakPrice" : "offPrice") }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                              "input",
                              {
                                id: `um-${fld}-${k}`,
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
                          ...
                          e.windows.map((p, pi) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 4, marginBottom: 4, flexWrap: "wrap" }, children: [
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.text3 }, children: tt("start") }),
                            ...
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.text3 }, children: tt("hourUnit") }),
                            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: t.text3 }, children: tt("end") }),
