  ...
  (0, import_react.useEffect)(() => {
    ...
    for (const p of modelDir) {
      for (const m of p.models) {
        ...
        d[k] = {
          input: num(prices?.inputPerM) !== void 0 ? String(prices?.inputPerM) : "",
          cache: num(prices?.cacheReadPerM) !== void 0 ? String(prices?.cacheReadPerM) : "",
          output: num(prices?.outputPerM) !== void 0 ? String(prices?.outputPerM) : ""
        };
      }
    }
    setDrafts(d);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "16px 24px 24px", fontSize: 13, color: t.text }, children: [
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 13 }, children: "\u52A0\u8F7D\u5168\u5C40\u914D\u7F6E\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 16, paddingTop: 12, borderTop: `1px solid ${t.borderSoft}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { fontWeight: 700, fontSize: 13, marginBottom: 4 }, children: "\u4F9B\u5E94\u5546\u5B9A\u4EF7\u7BA1\u7406" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 11, marginBottom: 8 }, children: "\u6309\u4F9B\u5E94\u5546 \u2192 \u6A21\u578B\u4E3A\u6BCF\u4E2A\u6A21\u578B\u8BBE\u7F6E\u300C\u8F93\u5165\uFF08\u7F13\u5B58\u672A\u547D\u4E2D\uFF09/ \u7F13\u5B58\u547D\u4E2D / \u8F93\u51FA\u300D\u5355\u4EF7\uFF0C\u4FDD\u5B58\u540E\u5199\u5165\u8BE5 provider/model \u7684\u4EF7\u683C\u8986\u76D6\u3002" }),
        modelsLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 12 }, children: "\u52A0\u8F7D\u6A21\u578B\u76EE\u5F55\u2026" }) : modelDir.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 12 }, children: "\u672A\u4ECE\u6A21\u578B\u76EE\u5F55\u83B7\u53D6\u5230\u6A21\u578B\u3002\u8BF7\u786E\u8BA4\u5F53\u524D\u7EC4\u5408\u5DF2\u6CE8\u518C LLM \u9002\u914D\uFF08`ctx.llm`\uFF09\u3002" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          ...
          (() => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4, color: t.text3, fontSize: 10 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { flex: 1, minWidth: 0 }, children: "\u6A21\u578B" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { width: 90, textAlign: "right" }, children: "\u8F93\u5165(\u672A\u547D\u4E2D)" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { width: 90, textAlign: "right" }, children: "\u7F13\u5B58\u547D\u4E2D" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { width: 90, textAlign: "right" }, children: "\u8F93\u51FA" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { width: 58 } }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { width: 78, textAlign: "right" } })
              ] }),
              active.models.map((m) => {
                ...
                return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { flex: 1, minWidth: 0, fontSize: 12, color: t.text2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: m.label }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { value: d.input, onChange: (e) => setDrafts((ds) => ({ ...ds, [k]: { ...d, input: e.target.value } })), placeholder: "\u5143/M", style: { width: 90, fontSize: 12, padding: "2px 4px", textAlign: "right", border: `1px solid ${t.border}`, borderRadius: 4, background: t.card, color: t.text } }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { value: d.cache, onChange: (e) => setDrafts((ds) => ({ ...ds, [k]: { ...d, cache: e.target.value } })), placeholder: "\u5143/M", style: { width: 90, fontSize: 12, padding: "2px 4px", textAlign: "right", border: `1px solid ${t.border}`, borderRadius: 4, background: t.card, color: t.text } }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { value: d.output, onChange: (e) => setDrafts((ds) => ({ ...ds, [k]: { ...d, output: e.target.value } })), placeholder: "\u5143/M", style: { width: 90, fontSize: 12, padding: "2px 4px", textAlign: "right", border: `1px solid ${t.border}`, borderRadius: 4, background: t.card, color: t.text } }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", onClick: () => void saveModelPrice(active.provider, m.model), style: { fontSize: 12, padding: "3px 8px", borderRadius: 6, border: `1px solid ${t.border}`, background: t.accent, color: t.text, cursor: "pointer", whiteSpace: "nowrap" }, children: "\u4FDD\u5B58" }),
                  st !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { width: 78, textAlign: "right", fontSize: 11, color: st.ok ? t.ok : t.error, whiteSpace: "nowrap" }, children: st.msg })
                ] }, m.model);
              })
            ] });
          })()
...
function PriceEditor({
  ...
  const [offPeakPrices, setOffPeakPrices] = (0, import_react.useState)(
    () => peakMode ? rows.map((r) => {
      const b = r.buckets[0] ?? "input";
  ...
  const [peakDays, setPeakDays] = (0, import_react.useState)(() => base?.peakDays ?? [1, 2, 3, 4, 5]);
  const [peakWindows, setPeakWindows] = (0, import_react.useState)(() => base?.peakWindows ?? [{ start: 540, end: 720 }, { start: 840, end: 1080 }]);
  const [windowText, setWindowText] = (0, import_react.useState)(() => (base?.peakWindows ?? [{ start: 540, end: 720 }, { start: 840, end: 1080 }]).map((w) => `${Math.floor(w.start / 60)}:${String(w.start % 60).padStart(2, "0")}-${Math.floor(w.end / 60)}:${String(w.end % 60).padStart(2, "0")}`).join(", "));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 6, paddingTop: 6, borderTop: `1px solid ${t.borderSoft}` }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...row, paddingBottom: 2, color: t.text3, fontSize: 10 }, children: [
      ...
      billing.peak && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { width: 86, textAlign: "right" }, children: "\u8C37\u4EF7\uFF08\u53EF\u6539\uFF09" })
    ] }),
    billing.peak && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 10, marginBottom: 2 }, children: "\u8C37\u4EF7\u7559\u7A7A = \u9AD8\u5CF0\xD70.5\uFF1B\u9AD8\u5CF0\u65F6\u6BB5\u9ED8\u8BA4\u5468\u4E00\u5230\u5468\u4E94 9-12 / 14-18\uFF08\u5317\u4EAC\u65F6\u95F4\uFF09\uFF0C\u53EF\u5728\u4E0B\u65B9\u4FEE\u6539\uFF1B\u5468\u516D\u5468\u65E5\u5168\u5929\u6309\u8C37\u4EF7" }),
    rowsState.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 2 }, children: [
      ...
      billing.peak && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          value: offPeakPrices[i] ?? "",
          onChange: (e) => setOffPeakPrices((os) => {
            const n = [...os];
            n[i] = e.target.value;
            return n;
          }),
    ...
    billing.peak && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 4, paddingTop: 4, borderTop: `1px solid ${t.borderSoft}`, fontSize: 11, color: t.text2 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginBottom: 2 }, children: "\u5206\u5CF0\u8C37\u7684\u661F\u671F\uFF08\u4E0D\u52FE = \u5168\u5929\u6309\u8C37\u4EF7\uFF1B\u5468\u516D\u5468\u65E5\u9ED8\u8BA4\u4E0D\u52FE\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 4 }, children: ["\u65E5", "\u4E00", "\u4E8C", "\u4E09", "\u56DB", "\u4E94", "\u516D"].map((w, d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { style: { fontSize: 11 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            type: "checkbox",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginBottom: 2 }, children: "\u9AD8\u5CF0\u65F6\u6BB5\uFF08\u5317\u4EAC\u65F6\u95F4\uFF0C\u683C\u5F0F\u5982 9:00-12:00, 14:00-18:00\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          value: windowText,
