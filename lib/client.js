    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          rate !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { whiteSpace: "nowrap", fontWeight: 700, ...rate >= 100 ? { background: "linear-gradient(90deg, #4d6bfe, #8b5cf6, #f59e0b)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" } : { color: rate >= 50 ? "#f59e0b" : "#38bdf8" } }, children: [
            "\xB7 ",
            tt("speed"),
            " ",
            rate.toFixed(1),
