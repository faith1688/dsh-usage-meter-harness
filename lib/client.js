...
function apply(ctx) {
  ...
  const shellLocaleService = ctx.locale;
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        style: {
          ...
          background: peakNow === "peak" ? withAlpha(theme.pill.peak, 0.13) : peakNow === "off" ? withAlpha(theme.pill.ringOff, 0.12) : withAlpha(theme.pill.flat, 0.11),
