    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          rate !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { whiteSpace: "nowrap", fontWeight: 700, ...rate >= 100 ? { display: "inline-block", overflow: "hidden", background: "linear-gradient(90deg, #4d6bfe, #8b5cf6, #f59e0b)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" } : rate >= 50 ? { display: "inline-block", overflow: "hidden", background: "linear-gradient(90deg, #4d6bfe, #8b5cf6)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" } : { display: "inline-block", overflow: "hidden", background: "linear-gradient(90deg, #fbbf24, #f59e0b)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" } }, children: [
            "\xB7 ",
            tt("speed"),
            " ",
            rate.toFixed(1),
