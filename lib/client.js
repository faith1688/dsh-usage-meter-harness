    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          rate !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { whiteSpace: "nowrap", fontWeight: 700, ...rate >= 100 ? { display: "inline-block", overflow: "hidden", background: "linear-gradient(90deg, #4d6bfe, #8b5cf6, #f59e0b)", WebkitBackgroundClip: "text", backgroundClip: "text", WebkitTextFillColor: "transparent" } : rate >= 50 ? { color: "#38bdf8", textShadow: "0 0 8px rgba(56,189,248,0.8), 0 0 16px rgba(77,107,254,0.5)" } : { color: "#f59e0b", textShadow: "0 0 8px rgba(245,158,11,0.6)" } }, children: [
            "\xB7 ",
            tt("speed"),
            " ",
            rate.toFixed(1),
