...
function PriceEditor({
  ...
  const [peakWindows, setPeakWindows] = (0, import_react.useState)(() => base?.peakWindows ?? [{ start: 9, end: 12 }, { start: 14, end: 18 }]);
  const [windowText, setWindowText] = (0, import_react.useState)(() => (base?.peakWindows ?? [{ start: 9, end: 12 }, { start: 14, end: 18 }]).map((w) => `${w.start}-${w.end}`).join(", "));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 6, paddingTop: 6, borderTop: `1px solid ${t.borderSoft}` }, children: [
    ...
    billing.peak && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 4, paddingTop: 4, borderTop: `1px solid ${t.borderSoft}`, fontSize: 11, color: t.text2 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { marginBottom: 2 }, children: "\u9AD8\u5CF0\u65F6\u6BB5\uFF08\u5317\u4EAC\u65F6\u95F4\uFF0C\u683C\u5F0F\u5982 9-12, 14-18\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          value: windowText,
