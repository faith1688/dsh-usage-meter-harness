...
function UsageMeterSettingsSection(_props) {
  ...
  const [priceSourceUrl, setPriceSourceUrl] = (0, import_react.useState)("");
  const [refreshIntervalMs, setRefreshIntervalMs] = (0, import_react.useState)("");
  ...
  const save = async () => {
    ...
    try {
      ...
      if (budget.trim() !== "") {
        ...
        if (!Number.isNaN(n) && n >= 0) patch.budget = n;
      }
      ...
      if (refreshIntervalMs.trim() !== "") {
        const ms = Number(refreshIntervalMs);
        if (!Number.isNaN(ms) && ms > 0) patch.refreshIntervalMs = ms;
      }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "16px 24px 24px", fontSize: 13, color: t.text }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { style: { fontSize: 18, fontWeight: 700, margin: "0 0 4px" }, children: "\u7528\u91CF\u8BA1\u91CF" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { style: { color: t.text3, fontSize: 12, margin: "0 0 12px" }, children: "\u5E01\u79CD\u3001\u9884\u7B97\u3001\u4EF7\u683C\u6E90\u4E0E DeepSeek \u4F59\u989D API Key \u7B49\u5168\u5C40\u8BBE\u7F6E\u3002\u5355\u4EF7\u4E0E\u5CF0\u8C37\u8BA1\u8D39\u8BF7\u5728\u4F1A\u8BDD\u7684\u7528\u91CF\u5361\u7247\u4E2D\u7F16\u8F91\u3002" }),
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 13 }, children: "\u52A0\u8F7D\u5168\u5C40\u914D\u7F6E\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: label, htmlFor: "um-currency", children: "\u5168\u5C40\u5E01\u79CD" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { id: "um-currency", value: currency, onChange: (e) => setCurrency(e.target.value), style: select, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: label, htmlFor: "um-budget", children: "\u6BCF\u4F1A\u8BDD\u9884\u7B97" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "um-budget", value: budget, onChange: (e) => setBudget(e.target.value), placeholder: `\u5982 100 (${currency === "USD" ? "$" : "\xA5"})/\u4F1A\u8BDD`, style: input })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: label, htmlFor: "um-init", children: "\u975E DeepSeek \u521D\u59CB\u4F59\u989D" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "um-init", value: initialBalance, onChange: (e) => setInitialBalance(e.target.value), placeholder: `\u5982 100 (${currency === "USD" ? "$" : "\xA5"})`, style: input })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: label, htmlFor: "um-url", children: "\u8FDC\u7AEF\u4EF7\u683C\u6E90 URL" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "um-url", value: priceSourceUrl, onChange: (e) => setPriceSourceUrl(e.target.value), placeholder: "https://\u2026/model_prices_and_context_window.json", style: input })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: label, htmlFor: "um-int", children: "\u5237\u65B0\u95F4\u9694\uFF08\u6BEB\u79D2\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { id: "um-int", value: refreshIntervalMs, onChange: (e) => setRefreshIntervalMs(e.target.value.replace(/\D/g, "")), placeholder: "\u9ED8\u8BA4 14400000\uFF084 \u5C0F\u65F6\uFF09", style: input })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
