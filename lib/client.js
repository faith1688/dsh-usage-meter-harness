...
function seedEntry(key, ov, bals) {
  ...
  return {
    ...
    balanceNative: bal !== void 0 && typeof bal.balance === "number" ? bal.balance : null,
...
function UsageMeterSettingsSection(_props) {
        ...
        setEdits((prev) => {
          ...
          for (const k of Object.keys(next)) {
            ...
            if (b !== void 0 && typeof b.balance === "number") {
              ...
              const native = cur?.balanceNative !== null && cur?.balanceNative !== void 0 ? cur.balanceNative : b.balance;
              const converted = cur !== void 0 && cur.currency !== walletCur ? convertAmount(native, walletCur, cur.currency, rateRef.current) : native;
              if (cur !== void 0) next[k] = { ...cur, balance: String(Math.round(converted * 1e6) / 1e6), balanceNative: b.balance, walletCurrency: walletCur };
            }
          }
          return next;
        });
  ...
  const switchCurrency = async (key, newCur) => {
    ...
    setEdits((s) => {
      ...
      if (base.balanceNative !== null) {
        next.balance = newCur === base.walletCurrency ? String(base.balanceNative) : String(Math.round(convertAmount(base.balanceNative, base.walletCurrency, newCur, rateRef.current) * 1e6) / 1e6);
      }
      return { ...s, [key]: next };
    });
  };
  const editNum = (key, fld, val) => {
    setEdits((s) => {
      ...
      if (fld === "balance") {
        const n = Number(val);
        const native = val.trim() === "" || Number.isNaN(n) ? null : cur.currency === cur.walletCurrency ? n : convertAmount(n, cur.currency, cur.walletCurrency, rateRef.current);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "16px 24px 24px", fontSize: 13, color: t.text }, children: [
    ...
    loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 13 }, children: "\u52A0\u8F7D\u5168\u5C40\u914D\u7F6E\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: field, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: label, htmlFor: "um-rate", children: "\u5F53\u524D\u6C47\u7387\uFF081 USD \u2248\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { flex: 1, display: "flex", gap: 8, maxWidth: 360, alignItems: "center" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 13, color: t.text }, children: [
            pageRate.usdToCny > 0 ? pageRate.usdToCny.toFixed(4) : "\u672A\u83B7\u53D6",
            " CNY"
          ] }),
          pageRate.updatedAt > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 11, color: Date.now() - pageRate.updatedAt > 24 * 3600 * 1e3 ? t.error : t.text3, whiteSpace: "nowrap" }, children: [
            ...
            Date.now() - pageRate.updatedAt > 24 * 3600 * 1e3 ? " \xB7 \u5DF2\u8D8524h\uFF0C\u5C06\u81EA\u52A8\u5237\u65B0" : ""
          ] }),
          ...
          })(), style: { fontSize: 11, padding: "2px 10px", borderRadius: 6, border: `1px solid ${t.border}`, background: t.card, color: t.text, cursor: "pointer", whiteSpace: "nowrap" }, children: "\u5237\u65B0\u6C47\u7387" })
        ] })
      ] }),
