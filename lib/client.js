...
function UsageMeterSettingsSection(_props) {
  ...
  const sectTitle = { fontSize: 12, fontWeight: 600, color: t.text2, margin: "0 0 6px" };
  const hint = { fontSize: 11, color: t.text3, lineHeight: 1.5 };
  const btnPrimary = { height: 30, padding: "0 20px", borderRadius: 6, border: "none", background: t.accent, color: t.text, fontSize: 13, fontWeight: 500, cursor: "pointer" };
  const btnGhost = { height: 30, padding: "0 20px", borderRadius: 6, border: `1px solid ${t.border}`, background: "transparent", color: t.text2, fontSize: 13, cursor: "pointer" };
  const btnSmall = { height: 26, padding: "0 12px", borderRadius: 6, border: `1px solid ${t.border}`, background: "transparent", color: t.text2, fontSize: 12, cursor: "pointer" };
        ...
        modelsLoading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 12, marginTop: 8 }, children: L("\u52A0\u8F7D\u6A21\u578B\u76EE\u5F55\u2026") }) : modelDir.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { color: t.text3, fontSize: 12, marginTop: 8 }, children: L("\u672A\u4ECE\u6A21\u578B\u76EE\u5F55\u83B7\u53D6\u5230\u6A21\u578B\u3002\u8BF7\u786E\u8BA4\u5F53\u524D\u7EC4\u5408\u5DF2\u6CE8\u518C LLM \u9002\u914D\uFF08ctx.llm\uFF09\u3002") }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 10 }, children: [
          ...
          (() => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: active.models.map((m) => {
              ...
              const cell = { width: "100%", minWidth: 80, maxWidth: 150, boxSizing: "border-box", textAlign: "right", height: CTL_H, padding: "0 8px", border: `1px solid ${t.border}`, borderRadius: 6, fontSize: 13, background: t.card, color: t.text };
              return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { border: `1px solid ${t.border}`, borderRadius: 6, overflow: "hidden" }, children: [
                ...
                isOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("fieldset", { disabled: locked, style: { border: "none", margin: 0, padding: 0, minWidth: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { padding: "12px 14px 14px", display: "flex", flexDirection: "column", gap: 10, opacity: locked ? 0.75 : void 0 }, children: [
