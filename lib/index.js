...
function applyPriceOverrides() {
    for (const [key, override] of Object.entries(priceOverrides)) {
        ...
        if (base === undefined) {
            ...
            if ((typeof p.inputPerM !== 'number' || typeof p.outputPerM !== 'number') && !hasCustom)
                continue;
            const row = {
...
function savePersistedConfig() {
    try {
        ...
        const payload = { providers: providerConfigs, priceOverrides, balances, globals };
                ...
                if (patch.model !== undefined && patch.model !== null && patch.provider !== undefined && patch.provider !== null) {
                    ...
                    if (override.reset === true) {
                        ...
                        if (typeof override.templateId === 'string')
                            next.templateId = override.templateId;
